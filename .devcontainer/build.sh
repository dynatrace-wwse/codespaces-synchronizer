...
docker run -e RepositoryName=$RepositoryName --privileged --dns=8.8.8.8 --network=host -v /var/run/docker.sock:/var/run/docker.sock -v /lib/modules:/lib/modules -v /home/ubuntu/codespaces-synchronizer:/workspaces/$RepositoryName -w /workspaces/$RepositoryName -it msubuntu /usr/bin/zsh -c "./.devcontainer/post-create.sh; ./.devcontainer/post-start.sh; zsh"
